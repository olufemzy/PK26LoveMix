...
const photos = [
  ...
  { src: 'images/gallery1.jpeg', label: 'Laughter',    size: 'tall',  row: 1, gradient: 'linear-gradient(135deg,#8b2a3f44,#2d101866)', icon: '😄' },
  { src: 'images/preview.jpeg', label: 'The Ring',    size: 'tall',    row: 1, gradient: 'linear-gradient(135deg,#c9a96e44,#6b1a2b55)', icon: '💍' },
  { src: 'images/gallery1.jpeg', label: 'Together',    size: 'tall',  row: 1, gradient: 'linear-gradient(135deg,#6b1a2b55,#4a0f1c77)', icon: '🤝' },
  { src: 'images/preview.jpeg', label: 'In Love',     size: 'tall',  row: 1, gradient: 'linear-gradient(135deg,#2d1018aa,#c9a96e22)', icon: '❤️' },
  { src: 'images/gallery1.jpeg', label: 'Rooftop',     size: 'tall',  row: 1, gradient: 'linear-gradient(135deg,#4a0f1c88,#8b2a3f44)', icon: '🏙️' },
